...
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP, \
U_LT(U_WIN, LA(TAB)),  &lth U_TMUX_TAP U_TMUX_HOLD,  U_WIN_LANG,  U_NA,  U_LT(U_VIVALDI, F2),  U_WIN_TERM

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_MAC \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MT(LSHFT, T),    &kp G,             &kp M,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP, \
U_LT(U_APP, LG(TAB)),  &lth U_TMUX_TAP U_TMUX_HOLD,  U_MAC_LANG,  U_NA,  U_LT(U_VIVALDI_MAC, F2),  U_MAC_TERM
...
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              &u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp C_STOP,        &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP, \
U_NA, U_NA, U_NA, U_NA, U_NA,  &u_bt_sel_4
...
&kp LG(LS(S)),   &kp LG(N7),   &kp LG(N8),         &kp LG(N9),         U_NA,             U_NA,             &kp LG(LC(LEFT)),   &kp LG(LS(LEFT)),   &kp LG(LS(RIGHT)),  &kp LG(LC(RIGHT)), \
...
U_NP,   U_NP,         &kp LG(LC(LEFT)),   &kp LG(LC(RIGHT)),  &kp LG(LS(GRAVE)),    &kp LG(LC(D)),    &kp LA(F4),         &kp LG(LC(F4)),     U_NP,               U_NP, \
U_NA,   U_NA, U_NA, U_NA, U_NA, U_NA
...
U_NP,             U_NP, &kp LC(F3), &kp LC(LS(DOWN)), &kp LC(LS(UP)), &kp LC(LA(RET)), U_NA,             U_NA,                 U_NP,                  U_NP, \
U_NA, U_NA, U_NA, U_NA, U_NA, U_NA

#define MIRYOKU_ALTERNATIVES_TMUX_TAP \
U_NA,   &tmx N7,  &tmx N8,      &tmx N9,  U_NA,         U_NA,        &tmx P,      &tmx N,      U_NA,        U_NA, \
...
U_NA,   &tmx N7,  &tmx N8,   &tmx N9,   U_NA,     U_NA,        &tmx P,          &tmx N,         U_NA,         U_NA, \
U_NA,   &tmx N4,  &tmx N5,   &tmx N6,   U_NA,     &tmx PIPE,   &tmx LEFT,       &tmx DOWN,      &tmx UP,      &tmx RIGHT, \
U_NA,   &tmx N1,  &tmx N2,   &tmx N3,   U_NA,     &tmx MINUS,  &tmx LA(LEFT),   &tmx LA(DOWN),  &tmx LA(UP),  &tmx LA(RIGHT), \
