...
#include "miryoku_layer_alternatives.h"
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_COLEMAKDH_MAC)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_MAC
    #elif defined (MIRYOKU_EXTRA_COLEMAKDHK)
    ...
    #elif defined (MIYOKU_EXTRA_COLEMAKDH_MAC)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_MAC
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY
    #endif
...
#if !defined(MIRYOKU_LAYER_WIN)
  #define MIRYOKU_LAYER_WIN MIRYOKU_ALTERNATIVES_WIN
#endif
#if !defined(MIRYOKU_LAYERMAPPING_WIN)
  #define MIRYOKU_LAYERMAPPING_WIN MIRYOKU_MAPPING
#endif

#if !defined(MIRYOKU_LAYER_APP)
  #define MIRYOKU_LAYER_APP MIRYOKU_ALTERNATIVES_APP
#endif
#if !defined(MIRYOKU_LAYERMAPPING_APP)
  #define MIRYOKU_LAYERMAPPING_APP MIRYOKU_MAPPING
#endif

#if !defined(MIRYOKU_LAYER_TMUX_TAP)
  #define MIRYOKU_LAYER_TMUX_TAP MIRYOKU_ALTERNATIVES_TMUX_TAP
#endif
#if !defined(MIRYOKU_LAYERMAPPING_TMUX_TAP)
  #define MIRYOKU_LAYERMAPPING_TMUX_TAP MIRYOKU_MAPPING
#endif

#if !defined(MIRYOKU_LAYER_TMUX_HOLD)
  #define MIRYOKU_LAYER_TMUX_HOLD MIRYOKU_ALTERNATIVES_TMUX_HOLD
#endif
#if !defined(MIRYOKU_LAYERMAPPING_TMUX_HOLD)
  #define MIRYOKU_LAYERMAPPING_TMUX_HOLD MIRYOKU_MAPPING
#endif

#if !defined(MIRYOKU_LAYER_VIVALDI)
  #define MIRYOKU_LAYER_VIVALDI MIRYOKU_ALTERNATIVES_VIVALDI
#endif
#if !defined(MIRYOKU_LAYERMAPPING_VIVALDI)
  #define MIRYOKU_LAYERMAPPING_VIVALDI MIRYOKU_MAPPING
#endif

#if !defined(MIRYOKU_LAYER_VIVALDI_MAC)
  #define MIRYOKU_LAYER_VIVALDI_MAC MIRYOKU_ALTERNATIVES_VIVALDI_MAC
#endif
#if !defined(MIRYOKU_LAYERMAPPING_VIVALDI_MAC)
  #define MIRYOKU_LAYERMAPPING_VIVALDI_MAC MIRYOKU_MAPPING
#endif
